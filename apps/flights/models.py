...
class Website(models.Model):
    ...
    base_redirect_url = models.CharField(max_length=512)
    one_adult_redirect_url = models.CharField(max_length=512, null=True, blank=True)
    two_adult_redirect_url = models.CharField(max_length=512, null=True, blank=True)
